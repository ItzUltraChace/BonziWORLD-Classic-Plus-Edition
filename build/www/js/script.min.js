...
// https://stackoverflow.com/questions/35321609/easeljs-sprite-onclick-returns-cors-error
...
function loadBonzis(a) {
    loadQueue.loadManifest([
        { id: "angel", src: "./img/bonzi/angel.png" },
        ...
        { id: "bonziDark_orange", src: "./img/bonzi/dark_orange.png" },
        ...
        { id: "dtv", src: "./img/bonzi/dtv.png" },
        { id: "bonziEmerald", src: "./img/bonzi/emerald.png" },
        { id: "flipped", src: "./img/bonzi/flipped.png" },
        { id: "four", src: "./img/bonzi/four.png" },
        ...
        { id: "bonziMagenta_blue", src: "./img/bonzi/magenta_blue.png" },
        { id: "max", src: "./img/bonzi/max.png" },
        { id: "megapope", src: "./img/bonzi/megapope.png" },
        { id: "merlin", src: "./img/bonzi/merlin.png" },
        { id: "bonziNew_pope", src: "./img/bonzi/new_pope.png" },
        { id: "bonziOrange", src: "./img/bonzi/orange.png" },
        { id: "bonziOrange2", src: "./img/bonzi/orange2.png" },
        { id: "peedy", src: "./img/bonzi/peedy.png" },
        { id: "pm", src: "./img/bonzi/pm.png" },
        { id: "pope_160", src: "./img/bonzi/pope_160.png" },
        ...
        { id: "bonziRainbowsaber", src: "./img/bonzi/rainbowsaber.png" },
        { id: "bonziRed", src: "./img/bonzi/red.png" },
        { id: "robby", src: "./img/bonzi/robby.png" },
        { id: "bonziTangerine", src: "./img/bonzi/tangerine.png" },
        { id: "bonziPink", src: "./img/bonzi/pink.png" },
        { id: "unbojih", src: "./img/bonzi/unbojih.png" },
        { id: "bonziYellow", src: "./img/bonzi/yellow.png" },
        { id: "bonziYellow2", src: "./img/bonzi/yellow2.png" },
        { id: "bonziYellow3", src: "./img/bonzi/yellow3.png" },
...
function setup() {
    $("#chat_send").click(sendInput),
        ...
        socket.on("stinky", function (a) {
            var b = bonzis[a.guid];
            b.cancel(), b.stinky(a.target);
        }),
        ...
        socket.on("triangular", function (a) {
            var b = bonzis[a.guid];
            if (b.doingTheFunny) return;
            b.doingTheFunny = true;
            if (b.mute) return;
            b.sprite.scaleX = -1;
            var audio = new Audio("motorola.wav");
            audio.play();

            b.updateRightNow = setInterval(function () {
                b.move();
            }, 1);
            setTimeout(function () {
                b.sprite.scaleX = 1;
            ...
            setTimeout(function () {
                b.sprite.scaleX = 1;
                b.speen = setInterval(function () {
                    b.sprite.rotation += 2;
                }, 1);
            }, 6861);
            setTimeout(function () {
                b.doingTheFunny = false;
                b.sprite.rotation = 0;
                b.move();
                clearInterval(b.speen);
                clearInterval(b.updateRightNow);
            }, 13652);
        }),
        ...
        socket.on("bonzikill", function (a) {
            var b = bonzis[a.guid];
            b.cancel();
            b.runSingleEvent(b.data.event_list_bonzikill);
        }),
        socket.on("bonzify", function (a) {
            var b = bonzis[a.guid];
            b.cancel();
            b.runSingleEvent(b.data.event_list_bonzify);
        }),
        socket.on("bonzikill2", function (a) {
            var b = bonzis[a.guid];
            b.cancel(); 
            b.runSingleEvent(b.data.event_list_bonzikill2);
        }),
...
function sendInput() {
    ...
    if (($("#chat_message").val(""), a.length > 0)) {
        ...
        } else socket.emit("talk", { text: a, say: a });
    }
}
...
var _createClass = (function () {
    ...
    Bonzi = (function () {
		...
		(this.color = this.userPublic.color),
            ...
            this.$nametag2 = document.getElementsByName(this.selNametag);
                this.updateName(),
                    ...
                    build: function (a, b) {
                        return {
                            items: {
                                ...
                                stinky: {
                                    name: "Call an Stinky Head",
                                    callback: function () {
                                        socket.emit("command", { list: ["stinky", d.userPublic.name] });
                                    },
                                },
                                quote: {
                                    name: "Quote",
                                    callback: function() {
                                        if(!d.last){
                                            alert("This user hasn't speaked yet. When the user speaks, you can quote that the user said.")
                                            return;
                                        }
        ...
        return (
            _createClass(a, [
                ...
                },
                {
                    key: "updateName",
                    value: function () {
                        this.userPublic.name = replaceAll(this.userPublic.name, "&lt;", "<");
                        this.userPublic.name = replaceAll(this.userPublic.name, "&gt;", ">");
                        this.userPublic.name = replaceAll(this.userPublic.name, "&lt;", "<");
                        this.userPublic.name = replaceAll(this.userPublic.name, "&amp;", "&");
                        this.$nametag.html(twemoji.parse(this.userPublic.name));
                    },
                },
                {
                    key: "youtube",
                        ...
                        if (!this.mute) {
                            ...
                            this.$dialog
                                ...
                                .html(
                                    "\n\t\t\t\t\t<" +
                                        b +
                                        ' type="text/html" width="480" height="270" allow="autoplay" \n\t\t\t\t\tsrc="https://www.youtube.com/embed/' +
                                        a +
                ...
                },
                {
                    ...
                    value: function (a) {
                        if (!this.mute) {
                            ...
                            this.$dialog
                                .addClass("bubble_autowidth")
                                .html(" <video width='480' loop autoplay controls id='bonziworld-video'><source src='" + a + "' type='video/mp4' loop>Your browser does not support the video tag.</video> "), this.$dialog.show();
                        }
                    },
                },
                {
                ...
                },
                {
                    ...
                    value: function (a) {
                        this.runSingleEvent([
                            ...
                            { type: "text", text: "You're a fucking stinky head!", say: "your a fucking stinky head!" },
                            { type: "anim", anim: "cool_fwd", ticks: 35 },
                            { type: "idle" },
                        ]);
                    },
                },
...
(BonziData.event_list_joke = [
    ...
    (BonziData.event_list_bonzify = [
        { 
            type: 'text',
            text: "Hello, I'm Bonzi."
        },
        { 
            type: 'text',
            text: "I'm here to destroy your computer again. But this time, it's an actual destruction."
        },
        { 
            type: 'text',
            text: "The first thing i'll do is to inject my beauty into all programs that start from now."
        },
        { 
            type: 'text',
            text: "I would not recommend to restart your page from now, because it might be a bit unstable..."
        },
        { 
            type: 'text',
            text: "If you want a bit for me, I will do even more than just that."
        },
        { 
            type: 'text',
            text: "I will spam your BonziWORLD with random executables, inject my code into them too, and let them corrupt your BonziWORLD."
        },
        { 
            type: 'text',
            text: "Your programs are my slaves from then, doesn't that sound great?"
        },
        { 
            type: 'text',
            text: "You've got 30 seconds left until i activate the final destruction."
        },
        { 
            type: 'text',
            text: "You should look around your system, because now I'm everywhere."
        },
        { 
            type: 'text',
            text: "You've got 20 seconds left until i activate the final destruction."
        },
        { 
            type: 'text',
            text: "You've got 10 seconds left until i activate the final destruction."
        },
        { 
            type: 'text',
            text: "Destruction of Death is now activated."
        },
        { 
            type: 'text',
            text: " My work is now done."
        },
        { 
            type: 'text',
            text: "Goodbye, expand dong."
        },
        { 
            type: 'text',
            text: "Just sit back and enjoy."
        },
    ]),
    (BonziData.event_list_bonzikill2 = [
        { type: "text", text: "...HEY TARDS ITS ME THE BLUE ASS NIGGA FROM ALLADIN HERE TO STEAL THE SHOW LIKE A MATHA FAHKA.." },
        { type: "text", text: "Riding with my top down, wit my jewelry on hey I'm just getin my hood on." },
        { type: "text", text: "I'm just, I'm just doing my thing I'm just, I'm just do doin my thing heey.." },
        { type: "text", text: "I know why ya doubtin.", say: "I know why ya doubtin." },
        { type: "text", text: "Yeah we gettin tha paypah..." },
    ]),
    (BonziData.event_list_bonzikill = [
        {
            type: "text",
            text:
                "Welcome to my world of {NAME}BUDDY! I will explore the Internet with you as your very own friend and sidekick!  I can talk, walk, joke, browse, search, e-mail, and download like no other friend you've ever had!  I even have the ability to compare prices on the products you love and help you save money! Best of all, I'm an absolute CUNT!.....",
            say:
                "Welcome to my world of {NAME}BUDDY! I will explore the Internet with you as your very own friend and sidekick!  I can talk, walk, joke, browse, search, e-mail, and download like no other friend you've ever had!  I even have the ability to compare prices on the products you love and help you save money! Best of all, I'm an absolute CUNT!",
        },
        { type: "text", text: "My man clippy is no longer with us" },
        { type: "text", text: "one time we got so fucked up on acid that we bent him into a pretzel and his dying words were........." },
        { type: "text", text: "come on man, gimme a cheese burger, i suck yo deek maaaan........." },
        { type: "text", text: "good TIMES..." },
        { type: "text", text: "Wanna hear the most annoying sound in the world?......" },
        { type: "text", text: "Actually I think there's a worse one....." },
        { type: "text", text: "LET   THE    BODIES    HIT    THE    FLOOR" },
        { type: "text", text: "LET   THE    BODIES    HIT    THE    FLOOR" },
        { type: "text", text: "LET   THE    BODIES    HIT    THE    " },
        { type: "text", text: "FLOOOOOOOOOOOOOOOOOOOOOOOOR" },
        { type: "text", text: "PC Optimizer Pro has been on my computer through 3 operating systems and I have checked out lots of ways to optimize, let me tell you! The way they have it organized is ....." },
        { type: "text", text: "AN ABSOLUTE FUCKING NIGHTMARE........." },
        { type: "text", text: "They offer a wide range of curry lovers to help steal your money cus they is snitches ......." },
        { type: "text", text: "then they tell you your computer has been unfucked by the MEMZ cleaning software.......?" },
        { type: "text", text: "Holy fuck look at the time, it's " + formatAMPM(new Date()) + "!" },
        { type: "text", text: "I think it's time to..." },
        { type: "text", text: "expand DONG" },
        { type: "text", text: "I just recieved 10 fresh new memes" },
        { type: "text", text: "and SiIvaGunner's new album... lets take a listen....." },
        { type: "text", text: "That was absolute garbo mate....." },
        { type: "text", text: "Enought chit chat, lets see what the bonz can do to make your PC better...." },
        { type: "text", text: "Lets optimize this shit...." },
        { type: "text", text: "bby u wan sum fuk fuk fuk fuk fuk fuk???", say: "baby you want some fahk fahk fahk fahk fahk fahk" },
        {
            type: "text",
            text:
                "Uh, sama lamaa duma lamaa you assuming I'm a human What I gotta do to get it through to you I'm superhuman Innovative and I'm made of rubber  So that anything you say i ricocheting off of me and it'll glue to you  I'm never stating, more than ever demonstrating How to give a motherfuckin' audience a feeling like it's levitating Never fading, and I know the haters are forever waiting For the day that they can say I fell off, they'd be celebrating Cause I know the way to get 'em motivated  make elevating music",
        },
        { type: "text", text: "biiiiiiiiiitch" },
        { type: "text", text: "I think we can do better...." },
        { type: "text", text: "This is a pretty great meme...." },
        { type: "text", text: "you always was a choosy ass nigga ballin with the droptop but it aint gon make you go no fasta mothafucka bout to go nice and slow for your bitch ass........" },
        { type: "text", text: "Hahahahahahahaha How The Fuck Is Cyber Bullying Real Hahahaha Nigga Just Walk Away From The Screen Like Nigga Close Your Eyes Haha" },
        { type: "text", text: "this is druuuuuuuuuuuuuuuuuuuuuug munney.........." },
        { type: "text", text: "I'll fuckk u up fam...." },
        { type: "text", text: "my longest yeah boi ever" },
        { type: "text", text: "yeah boiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii" },
        { type: "text", text: "Niko!!! Want to go bowlink?????" },
        { type: "text", text: "Did you watch long enough to see the bald guy's pussy?" },
        { type: "text", text: "This shit is lit fam!!!!!!!" },
        { type: "text", text: "nigga what is grape juice?" },
    ]),
...
$(document).ready(function () {
    var auCtx = new (window.AudioContext || window.webkitAudioContext)({ latencyHint: "interactive", sampleRate: 44100 }) || (window.AudioContext || window.webkitAudioContext);
    window.auCtx = auCtx;
    window.BonziHandler = new (function () {
        return (
            ...
            (this.prepSprites = function () {
                for (var a = ["_", "angel", "black", "blue", "bonzi", "brown", "clippy", "cyan", "dark_orange", "dark_purple", "dark_red", "diamond", "dtv", "emerald", "flipped", "four", "genie", "gold", "green", "grey", "lemon", "lime", "magenta", "magenta_blue", "max", "milkmankarlson", "merlin", "new_pope", "orange", "orange2", "peedy", "pm", "purple", "purplesaber", "rainbow", "rainbowsaber", "red", "robby", "pink", "tangerine", "yellow", "yellow2", "yellow3", "pope", "pope2", "pope_160", "peedy_pope", "megapope", "god"], b = 0; b < a.length; b++) {
                    var c = a[b],
            ...
            (this.speak = function (a, b, c, d) {
                var e = { samples_queue: [] };
                espeak.setVoice.apply(espeak, ["english-us", "en-us"]),
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["angel", "bonzi", "bonziBlack", "bonziBlue", "bonziBrown", "clippy", "bonziCyan", "bonziDark_orange", "bonziDark_purple", "bonziDark_red", "bonziDiamond", "dtv", "bonziEmerald", "flipped", "four", "genie", "bonziGold", "bonziGreen", "bonziGrey", "bonziLemon", "bonziLime", "bonziMagenta", "bonziMagenta_blue", "max", "merlin", "bonziNew_pope", "bonziOrange", "bonziOrange2", "peedy", "pm", "pope_160", "bonziPurple", "bonziPurplesaber", "bonziRainbow", "bonziRainbowsaber", "bonziRed", "robby", "bonziTangerine", "bonziPink", "unbojih", "bonziYellow", "bonziYellow2", "bonziYellow3", "topjej"];
...
$(function () {
    $("#login_go").click(loadTest),
      ...
      socket.on("choose_rank", function (a, p) {
          $("#page_rank").show();
      }),
      socket.on("spawn_bonzi", function (a, p) {
          $("#page_spawnbonzi").show();
      }),
      socket.on("spawn_bonzi_spam", function (a, p) {
          $("#page_spawnbonzispam").show();
      }),
      socket.on("assistant_changer", function (a, p) {
          $("#page_bwrassistant").show();
      }),
