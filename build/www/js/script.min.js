    ...
    window.BonziHandler = new (function () {
        return (
            ...
            (this.prepSprites = function () {
                for (var a = ["black", "blue", "bonzi", "brown", "cyan", "dark_orange", "dark_purple", "dark_red", "diamond", "emerald", "gold", "green", "grey", "lemon", "lime", "magenta", "magenta_blue", "max", "merlin", "new_pope", "orange", "orange2", "peedy", "pm" "purple", "rainbow", "red", "robby", "pink", "tangerine", "yellow", "yellow2", "yellow3", "pope", "god"], b = 0; b < a.length; b++) {
                    var c = a[b],
